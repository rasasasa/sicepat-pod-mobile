...
Mobile.setText(findTestObject('Scan masuk/Kolom Masukkan Nomor Resi'), '100028551114', 0)

Mobile.tap(findTestObject('Scan masuk/Tombol Submit'), 0)

Mobile.delay(2, FailureHandling.STOP_ON_FAILURE)

Mobile.checkElement(findTestObject('Scan masuk/Element - A1'), 0)
...
Mobile.takeScreenshot('D:\\SS katalon\\scan masuk A1.png', FailureHandling.STOP_ON_FAILURE)
