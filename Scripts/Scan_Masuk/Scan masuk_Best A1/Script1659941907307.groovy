...
Mobile.setText(findTestObject('Scan masuk/Kolom Masukkan Nomor Resi'), '100011551103', 0)

Mobile.tap(findTestObject('Scan masuk/Tombol Submit'), 0)

Mobile.delay(2, FailureHandling.STOP_ON_FAILURE)

Mobile.checkElement(findTestObject('Scan masuk/Element BEST-A1'), 0)
...
Mobile.takeScreenshot('D:\\SS katalon\\scan masuk BEST A1.png', FailureHandling.STOP_ON_FAILURE)
