...
Mobile.setText(findTestObject('Scan Antar/Masukkan Nomor Resi'), '109303245095', 0)

Mobile.tap(findTestObject('Scan Antar/Submit'), 0)

Mobile.delay(2, FailureHandling.STOP_ON_FAILURE)

Mobile.takeScreenshot('D:\\SS katalon\\scan antar resi retur yang di cancel retur.png', FailureHandling.STOP_ON_FAILURE)
