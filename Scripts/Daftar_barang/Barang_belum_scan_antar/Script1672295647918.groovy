...
Mobile.tap(findTestObject('Daftar Barang/Barang belum scan antar'), 0)
...
Mobile.takeScreenshot('D:\\SS katalon\\Daftar barang belum scan antar.png', FailureHandling.STOP_ON_FAILURE)
