...
Mobile.setText(findTestObject('Scan masuk/Kolom Masukkan Nomor Resi'), '100018551118', 0)

Mobile.tap(findTestObject('Scan masuk/Tombol Submit'), 0)

Mobile.delay(2, FailureHandling.STOP_ON_FAILURE)

Mobile.checkElement(findTestObject('Scan masuk/Element kode X1'), 0)

Mobile.delay(1, FailureHandling.STOP_ON_FAILURE)

Mobile.takeScreenshot('D:\\SS katalon\\wilayah belum termapping.png', FailureHandling.STOP_ON_FAILURE)
